 ...
 * 
 */
console.log("====== 배열생성1: 내장객체(생성자 함수)를 사용하는 방법 ======");
var a1 = new Array();
...
a6[0] = 0;
a6['1'] = 1;
// 아래 속성은 length 증가하지 않음
a6.name = '둘리';
a6.age = 10;

console.log(a6['0'], a6[1], a6, a6.length); // length = 2

// object의 length -> undefined (배열과 차이점)
// length를 수동으로 설정해주면 배열과 같음
var o6 = {};
o6.length = 0;
