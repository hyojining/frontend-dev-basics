...
const {firstName, lastName, email} = user; // = 왼쪽은 const나 let이 꼭 붙어야 함
...
// ex3 - 그조 분해 대상이 되는 객체의 속성 이름과 변수 이름이 다를 경우
const person = {
    n: '마이콜',
    c: 'korea'
}
...
console.log(firstColor, secondColor, otherColors); // otherColors는 배열로 출력
